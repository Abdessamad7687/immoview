...
export function PropertyCard({ property }: PropertyCardProps) {
  ...
  return (
    <>
      <div
        ref={cardRef}
        className="relative h-[calc(100vh-7.5rem)] w-full snap-start snap-always mb-3 px-2 lg:h-[600px] lg:rounded-2xl lg:overflow-hidden lg:mb-0 lg:px-0"
      >
        <video
          ref={videoRef}
        ...
        <div className="absolute inset-0 flex flex-col justify-between p-5 pb-6 safe-area-inset">
          ...
          <div className={`flex items-end gap-3 ${isRTL ? "flex-row-reverse" : ""}`}>
            <div className="flex-1 space-y-2 pb-16 lg:pb-3">
            ...
            <div className="flex flex-col items-center gap-4 pb-16 lg:pb-3">
              <button
                onClick={handleLike}
